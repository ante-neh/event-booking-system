...
const userProfileSchema = z.object({
  first_name: z
    .string()
    .trim()
    .min(2, "first name should be atleast two characters"),
  last_name: z
    .string()
    .trim()
    .min(2, "last name should be atleast two characters"),
  bio: z
    .string()
    .trim()
    .min(10, "bio should be atleast 10 characters")
    .optional(),
  phone_number: z
    .string()
    .regex(ethiopianPhoneRegex, {
      message: "Invalid Ethiopian phone number (must start with 07 or 09)",
    })
    .transform((val) => {
